...
public class FindMaxAndMinFromArray {
	...
	//Both method wil lfind out max and min value from array
	...
	static void findMaxAndMin(int[] arrNum) {
		...
		int max = Integer.MIN_VALUE;//min number will be store at first to max variable
		int min = Integer.MAX_VALUE;//max number will be store at first to min variable
